...
public class AuthorizationServerConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        ...
        RegisteredClient gearFirstClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientSecret(passwordEncoder.encode("secret")) // BCrypt 인코딩
                ...
                .redirectUri("http://localhost:8080/login-success")
                //클라이언트가 요청 가능한 접근 범위
                .scope("profile")
                .scope("email")
                //토큰 관련 정책
                ...
                .clientSettings(ClientSettings.builder()
                        ...
                        .requireProofKey(false) // PKCE 비활성화 (테스트용)
                        .build())
                .build();
        //메모리 기반 저장소
    ...
    public AuthorizationServerSettings authorizationServerSettings() {
        return AuthorizationServerSettings.builder()
                .issuer("http://localhost:8080") // JWT iss 값으로 사용됨
                .build();
    }
