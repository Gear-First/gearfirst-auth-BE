...
public class CustomRequestCache extends HttpSessionRequestCache {
    ...
    public void saveRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        //  /error는 저장하지 않음
        if (uri.startsWith("/error") ||  uri.startsWith("/.well-known/") || uri.startsWith("/favicon.ico")) {
            System.out.println(" [CustomRequestCache] /error 또는 /.well-known/ 또는 /favicon.ico 요청은 저장하지 않음");
            return;
        }
